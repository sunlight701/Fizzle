...
public class DaemonService {
    ...
    synchronized public void startDaemon() {
        if (!mDaemonStarted) {
            mDaemonStarted = true;
            ch.seme.utils.Log.i(TAG, "Starting daemon ...");
            ...
            ch.seme.utils.Log.i(TAG, "DaemonService started");
        }
    }
    ...
    synchronized public void stopDaemon() {
        mExecutor.shutdown();
        if (mDaemonStarted) {
            ch.seme.utils.Log.i(TAG, "stopping daemon ...");
            Ringservice.fini();
            mDaemonStarted = false;
            ch.seme.utils.Log.i(TAG, "DaemonService stopped");
        }
    }
    ...
    class DaemonPresenceCallback extends PresenceCallback {
        ...
        public void newServerSubscriptionRequest(String remote) {
            ch.seme.utils.Log.d(TAG, "newServerSubscriptionRequest: " + remote);
        }

        @Override
        public void serverError(String accountId, String error, String message) {
            ch.seme.utils.Log.d(TAG, "serverError: " + accountId + ", " + error + ", " + message);
        }
        ...
        public void subscriptionStateChanged(String accountId, String buddyUri, int state) {
            ch.seme.utils.Log.d(TAG, "subscriptionStateChanged: " + accountId + ", " + buddyUri + ", " + state);
        }
    }
    ...
    private class DaemonVideoCallback extends VideoCallback {
        ...
        public void startCapture(String camId) {
            ch.seme.utils.Log.d(TAG, "startCapture: " + camId);
