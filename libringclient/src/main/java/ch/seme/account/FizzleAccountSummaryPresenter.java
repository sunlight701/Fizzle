...
public class FizzleAccountSummaryPresenter extends RootPresenter<FizzleAccountSummaryView> {

    private static final String TAG = FizzleAccountSummaryPresenter.class.getSimpleName();
    ...
    @Inject
    public FizzleAccountSummaryPresenter(AccountService accountService,
    ...
    public void setAccountId(String accountID) {
        ...
        FizzleAccountSummaryView v = getView();
        ...
        mCompositeDisposable.add(mAccountService.getObservableAccountUpdates(mAccountID)
                .observeOn(mUiScheduler)
                .subscribe(a -> {
                    FizzleAccountSummaryView view = getView();
                    if (view != null)
