...
import ch.seme.utils.ProfileChunk;
...
public class SipCall extends Interaction {
    ...
    private ch.seme.utils.ProfileChunk mProfileChunk = null;
    ...
    public VCard appendToVCard(Map<String, String> messages) {
        for (Map.Entry<String, String> message : messages.entrySet()) {
            HashMap<String, String> messageKeyValue = ch.seme.utils.VCardUtils.parseMimeAttributes(message.getKey());
            String mimeType = messageKeyValue.get(ch.seme.utils.VCardUtils.VCARD_KEY_MIME_TYPE);
            if (!ch.seme.utils.VCardUtils.MIME_PROFILE_VCARD.equals(mimeType)) {
                continue;
            }
            int part = Integer.parseInt(messageKeyValue.get(ch.seme.utils.VCardUtils.VCARD_KEY_PART));
