...
public class ConversationPath {
    ...
    public static Uri toUri(String accountId, @NonNull ch.seme.model.Uri conversationUri) {
        return ContentUriHandler.CONVERSATION_CONTENT_URI.buildUpon()
                .appendEncodedPath(accountId)
    ...
    public static Uri toUri(@NonNull Interaction interaction) {
        return toUri(interaction.getAccount(), new ch.seme.model.Uri(interaction.getConversation().getParticipant()));
    }
    ...
    public static Bundle toBundle(String accountId, ch.seme.model.Uri uri) {
    ...
    public ch.seme.model.Uri getConversationUri() {
        return new ch.seme.model.Uri(conversationId);
    }
}
