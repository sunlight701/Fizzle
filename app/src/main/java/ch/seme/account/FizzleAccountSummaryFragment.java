...
import ch.seme.databinding.FragAccSummaryBinding;
...
import ch.seme.fragments.QRCodeFragment;
...
public class FizzleAccountSummaryFragment extends BaseSupportFragment<FizzleAccountSummaryPresenter> implements
        RegisterNameDialog.RegisterNameDialogListener,
        FizzleAccountSummaryView, ChangePasswordDialog.PasswordChangedListener,
    ...
    public static final String TAG = FizzleAccountSummaryFragment.class.getSimpleName();
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        mAccount = mAccountService.getAccount(mAccountId);
        ...
        mBinding.scrollview.getViewTreeObserver().addOnScrollChangedListener(this);
        mBinding.settingsChangePassword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                onPasswordChangeAsked();
            }
        });
        mBinding.settingsExport.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                onClickExport();
            }
    ...
    private void setLinkedDevicesAdapter(Account account) {
        if (account.getDevices().size() == 1) {
            ...
            if (mDeviceAdapter == null) {
                mDeviceAdapter = new DeviceAdapter(requireContext(), account.getDevices(), account.getDeviceId(), FizzleAccountSummaryFragment.this);
                mBinding.chipMore.setText(getString(R.string.account_link_show_button, mDeviceAdapter.getCount()));
