...
import ch.seme.R;
import ch.seme.account.FizzleAccountSummaryPresenter;
import ch.seme.account.FizzleAccountSummaryView;
import ch.seme.application.FizzleApplication;
import ch.seme.model.Account;
import ch.seme.utils.AndroidFileUtils;

public class TVAccountExport extends FizzleGuidedStepFragment<FizzleAccountSummaryPresenter>
        implements FizzleAccountSummaryView {
